...
describe('L1 Session', () => {
  ...
  describe('Session list in sidebar', () => {
    it('sessions section should be visible in nav panel', async function () {
      ...
      const sessionsSection = await $('.sparo-nav-panel__inline-list');
    ...
    it('session list should show sessions', async function () {
      ...
      const sessionItems = await browser.$$('.sparo-nav-panel__inline-item');
  ...
  describe('Session switching', () => {
    ...
    it('active session should be highlighted', async function () {
      ...
      const activeSessions = await browser.$$('.sparo-nav-panel__inline-item.is-active');
  ...
  describe('Panel mode', () => {
    it('should be able to toggle panel mode', async function () {
      ...
      const resizer = await $('.sparo-pane-resizer');
