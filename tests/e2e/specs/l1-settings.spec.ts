...
describe('L1 Settings', () => {
  ...
  describe('Settings panel opening', () => {
    it('settings button should be visible', async function () {
      ...
      const selectors = [
        ...
        '.sparo-header-right button',
        '.sparo-nav-bar__right button',
      ...
      if (!buttonFound) {
        ...
        const headerContainers = [
          '.sparo-header-right',
          '.sparo-nav-bar__right',
          '.sparo-nav-bar__controls',
          '.sparo-nav-bar',
        ];
      ...
      if (!buttonFound) {
        ...
        const header = await $('.sparo-nav-bar, .sparo-header');
    ...
    it('clicking settings button should open panel', async function () {
      ...
      const panel = await $('.sparo-config-center-panel');
  ...
  describe('Configuration modification', () => {
    it('settings should have form inputs', async function () {
      ...
      const inputs = await browser.$$('.sparo-config-center-panel input, .sparo-config-center-panel select, .sparo-config-center-panel textarea');
  ...
  describe('Settings panel closing', () => {
    it('settings panel should be closable', async function () {
      ...
      const backdrop = await $('.sparo-config-center-backdrop');
