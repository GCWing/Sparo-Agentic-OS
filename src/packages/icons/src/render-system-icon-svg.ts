...
export function renderSystemIconSvg({
  ...
  if (variant === 'emphasis') {
    ...
    return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 ${SPARO_ICON_VIEWBOX_SIZE} ${SPARO_ICON_VIEWBOX_SIZE}" fill="none" style="--sparo-icon-detail-stroke-width: ${detailStrokeWidth}" data-sparo-icon="${name}" data-sparo-variant="emphasis">${titleMarkup}
  ${backgroundMarkup}
...
${body}
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 ${SPARO_ICON_VIEWBOX_SIZE} ${SPARO_ICON_VIEWBOX_SIZE}" fill="none" stroke="${safeColor}" stroke-width="${resolvedStrokeWidth}" stroke-linecap="round" stroke-linejoin="round" style="--sparo-icon-detail-stroke-width: ${detailStrokeWidth}" data-sparo-icon="${name}" data-sparo-variant="base">${titleMarkup}
${body}
</svg>\n`;
}
