...
export const messages: Record<MobileLanguage, MessageTree> = {
  'en-US': {
    ...
    sessions: {
      ...
      agentBitFunCoderDesc: 'AI coding and engineering tasks',
      ...
      appBuilderDesc: 'Build and preview Product Apps',
