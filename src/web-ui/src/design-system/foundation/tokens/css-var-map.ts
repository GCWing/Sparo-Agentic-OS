...
export function createThemeCssVarMap(theme: ThemeConfig): CssVarMap {
  ...
  const vars: CssVarMap = {
    ...
    '--ds-color-brand-core': tokens.color.brand.core,
    '--ds-color-brand-action': tokens.color.brand.action,
    '--ds-color-brand-action-hover': tokens.color.brand.actionHover,
    '--ds-color-brand-action-active': tokens.color.brand.actionActive,
    '--ds-color-brand-on-action': tokens.color.brand.onAction,
    '--ds-color-brand-focus-ring': tokens.color.brand.focusRing,
