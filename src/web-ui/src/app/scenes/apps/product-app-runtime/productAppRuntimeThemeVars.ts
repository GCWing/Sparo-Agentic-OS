...
export interface ProductAppRuntimeThemePayload {
  type: ThemeType;
  id: string;
  vars: Record<string, string>;
}

export function buildProductAppRuntimeThemeVars(theme: ThemeConfig | null): ProductAppRuntimeThemePayload | null {
