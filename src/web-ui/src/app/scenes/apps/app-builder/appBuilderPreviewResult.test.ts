...
import { buildWorkBuilderPreviewResultFromToolResult } from './appBuilderPreviewResult';
...
describe('appBuilderPreviewResult', () => {
  it('projects RunBuilderPreview capability results into Work graph preview facts', () => {
    const preview = buildWorkBuilderPreviewResultFromToolResult({
      status: 'passed',
  ...
  it('derives issue counts when RunBuilderPreview summary is absent', () => {
    const preview = buildWorkBuilderPreviewResultFromToolResult({
      status: 'notVerified',
