...
export interface ResolvedSurfaceComponentMeta {
  name: string;
  description: string;
  tags: string[];
}
...
export function resolveSurfaceComponentMeta(app: SurfaceComponentMeta, locale?: string): ResolvedSurfaceComponentMeta {
