...
import type { DocumentAction, DocumentIntent, DocumentScope } from './protocol';
import type { SuggestionEntry } from './suggestionStore';
import type { DocumentDiffReview } from './documentDiff';
...
interface CoauthorControlsProps {
  ...
  documentDiff?: DocumentDiffReview | null;
  ...
  onIntentChange: (intent: DocumentIntent) => void;
  ...
  return (
    <div className="m-editor-coauthor" data-testid="md-coauthor-bar">
      ...
      <Select
        ...
        disabled={busy}
        onChange={(value) => onScopeChange(value as DocumentScope)}
      />
