...
export type MarkdownEditingSurfaceProps = EditorOptions;
...
export const MarkdownEditingSurface = forwardRef<EditorInstance, MarkdownEditingSurfaceProps>((props, ref) => {
  const {
  ...
  const placeholder = placeholderProp ?? t('markdown.tiptap.placeholder')
  ...
  return (
    <div
      ...
      tabIndex={-1}
    >
      {toolbar && <div className="m-editor-toolbar">{t('markdown.tiptap.toolbarPlaceholder')}</div>}
...
MarkdownEditingSurface.displayName = 'MarkdownEditingSurface'
