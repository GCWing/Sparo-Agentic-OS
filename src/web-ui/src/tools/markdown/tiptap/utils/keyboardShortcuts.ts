...
export const SHORTCUTS = {
  UNDO: { description: () => i18nService.t('tools:markdown.tiptap.shortcuts.undo'), key: 'z', modKey: true },
  REDO_SHIFT: { description: () => i18nService.t('tools:markdown.tiptap.shortcuts.redo'), key: 'z', modKey: true, shiftKey: true },
  REDO_Y: { description: () => i18nService.t('tools:markdown.tiptap.shortcuts.redo'), key: 'y', modKey: true },
  SAVE: { description: () => i18nService.t('tools:markdown.tiptap.shortcuts.save'), key: 's', modKey: true },
  ESCAPE: { description: () => i18nService.t('tools:markdown.tiptap.shortcuts.escape'), key: 'Escape' },
  
  INDENT: { description: () => i18nService.t('tools:markdown.tiptap.shortcuts.indent'), key: 'Tab' },
  OUTDENT: { description: () => i18nService.t('tools:markdown.tiptap.shortcuts.outdent'), key: 'Tab', shiftKey: true },
  
  BOLD: { description: () => i18nService.t('tools:markdown.tiptap.shortcuts.bold'), key: 'b', modKey: true },
  ITALIC: { description: () => i18nService.t('tools:markdown.tiptap.shortcuts.italic'), key: 'i', modKey: true },
  LINK: { description: () => i18nService.t('tools:markdown.tiptap.shortcuts.link'), key: 'k', modKey: true },
  NEW_BLOCK: { description: () => i18nService.t('tools:markdown.tiptap.shortcuts.newBlock'), key: 'Enter', modKey: true },
} as const
...
export const insertLink = (
  ...
  if (selected.length > 0) {
    ...
    const linkText = i18nService.t('tools:markdown.tiptap.insertLinkTextPlaceholder')
