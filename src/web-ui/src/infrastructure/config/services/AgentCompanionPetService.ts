...
const BUILTIN_PETS: AgentCompanionPetSelection[] = [
  DEFAULT_AGENT_COMPANION_PET,
  {
    id: 'assistant',
    displayName: '助理',
    description: 'A polished 3D red-and-white intelligent assistant companion with warm creative energy.',
    source: 'preset',
    packagePath: `${BUILTIN_PET_BASE}/assistant`,
    spritesheetPath: `${BUILTIN_PET_BASE}/assistant/spritesheet.webp`,
    spritesheetMimeType: 'image/webp',
  },
  {
    id: 'panda-pix',
    displayName: 'Panda',
    description: 'A compact pixel panda atlas for focused work sessions.',
    source: 'preset',
