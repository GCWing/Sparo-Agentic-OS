...
pub fn run() {
    ...
    let run_result = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::prompt_library_api::list_prompt_assets,
            api::prompt_library_api::get_prompt_asset,
            api::prompt_library_api::save_prompt_asset,
            api::prompt_library_api::validate_prompt_content,
            api::prompt_library_api::validate_prompt_asset,
            api::prompt_library_api::get_prompt_asset_git_status,
            api::prompt_library_api::get_prompt_asset_git_diff,
            api::prompt_library_api::get_prompt_asset_git_history,
            api::prompt_library_api::rollback_prompt_asset,
            api::prompt_library_api::list_git_prompt_history,
            api::prompt_library_api::get_prompt_review_trace,
            api::prompt_library_api::list_prompt_values,
            api::prompt_library_api::record_prompt_value_signal,
            api::prompt_library_api::request_prompt_llm_assessment,
            api::prompt_library_api::list_prompt_history,
            api::prompt_library_api::promote_prompt_history_to_asset,
