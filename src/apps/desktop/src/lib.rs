...
pub fn run() {
    ...
    let run_result = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::prompt_library_api::list_git_prompt_commits,
            api::prompt_library_api::get_prompt_git_branches,
            api::prompt_library_api::get_prompt_git_head_snapshot,
            api::prompt_library_api::list_prompt_history,
            api::prompt_library_api::get_prompt_lineage,
            api::prompt_library_api::toggle_prompt_pin,
