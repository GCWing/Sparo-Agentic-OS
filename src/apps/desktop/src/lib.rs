...
pub async fn run() {
    ...
    let run_result = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::live_app_api::live_app_agentic_create_session,
            api::live_app_api::live_app_agentic_send_message,
            api::live_app_api::live_app_agentic_cancel_turn,
            api::live_app_api::live_app_agentic_list_sessions,
            api::live_app_api::live_app_agentic_restore_session,
            api::live_app_api::live_app_agentic_delete_session,
            api::live_app_api::live_app_agentic_confirm_tool,
            api::live_app_api::live_app_agentic_reject_tool,
