//! PPT Live export rasterization via the desktop system WebView (WKWebView / WebView2).
...
const EXPORT_HOST_LABEL: &str = "ppt-live-export-host";

#[derive(Debug, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct LiveAppRenderSlidePageRequest {
    pub html: String,
    pub format: String,
...
fn file_url_for_export_html<R: tauri::Runtime>(
    ...
    let export_dir = cache_dir.join("ppt-live-export");
...
#[tauri::command]
pub async fn live_app_render_slide_page(
    app: AppHandle,
    request: LiveAppRenderSlidePageRequest,
