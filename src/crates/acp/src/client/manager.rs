...
impl AcpClientService {
    ...
    pub async fn create_derived_flow_session_record(
        &self,
        session_storage_path: &Path,
        workspace_path: &str,
        client_id: &str,
        ...
        self.session_persistence
            .create_derived_flow_session_record(
                session_storage_path,
                workspace_path,
                client_id,
                session_name,
    ...
    pub async fn create_dispatched_flow_session_record(
        &self,
        session_storage_path: &Path,
        workspace_path: &str,
        client_id: &str,
    ...
    async fn register_configured_tools(
        ...
        registry.unregister_tools_with_prefix("acp__");
