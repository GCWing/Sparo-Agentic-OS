//! Product App Runtime Host UI Kit.
//!
//! This is a small, stable runtime subset of the Web UI component library for
//! sandboxed Product App Runtime Host surfaces. It intentionally uses plain DOM helpers plus CSS class
//! contracts that mirror the component-library primitives, so Product App Runtime Host surfaces can use
...
/// through Product App Runtime Host theme variables.
