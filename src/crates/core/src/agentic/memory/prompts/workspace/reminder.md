...
You MUST only use content from the last ~__RECENT_MESSAGE_COUNT__ messages. Do not investigate the repository, run git commands, or verify repo facts. This job is durable memory extraction from recent conversation only.
