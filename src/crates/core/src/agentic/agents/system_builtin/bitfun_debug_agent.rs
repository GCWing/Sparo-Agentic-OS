//! Debug mode for BitFun Coder - Evidence-driven debugging
...
impl Default for BitFunDebugAgent {
    fn default() -> Self {
        Self::new()
    }
}

impl BitFunDebugAgent {
    pub fn new() -> Self {
        Self {
            id: "bitfun-debug",
            name: "Debug",
            description:
                "Debug mode for evidence-driven software diagnosis and repair inside BitFun Coder",
        }
    }
...
#[async_trait]
impl Agent for BitFunDebugAgent {
    ...
    async fn build_prompt(&self, context: &PromptBuilderContext) -> CoreResult<String> {
        ...
        let system_prompt_template = get_embedded_prompt("bitfun_debug_agent")
