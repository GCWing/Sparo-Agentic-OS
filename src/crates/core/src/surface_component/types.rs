//! Surface Component types: data model and permissions for ESM UI and Node Worker.
...
pub enum SurfaceComponentBuildMode {
    NativeEsm,
    Bundled,
}

impl Default for SurfaceComponentBuildMode {
    fn default() -> Self {
        Self::NativeEsm
    }
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct SurfaceComponentEntry {
...
impl Default for SurfaceComponentEntry {
    fn default() -> Self {
        Self {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct SurfaceComponentSourceFile {
    pub path: String,
    #[serde(default)]
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub enum SurfaceComponentSourceFileKind {
    Script,
    Style,
    Html,
    Worker,
...
impl Default for SurfaceComponentSourceFileKind {
    fn default() -> Self {
        Self::Asset
    }
}

/// Surface Component source: UI layer (browser) + Worker layer (Node.js).
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SurfaceComponentSource {
    pub html: String,
    pub css: String,
    ...
    #[serde(default)]
    pub entry: SurfaceComponentEntry,
    #[serde(default)]
    pub source_files: Vec<SurfaceComponentSourceFile>,
}
...
impl Default for SurfaceComponentSource {
    fn default() -> Self {
        Self {
            html: String::new(),
            css: String::new(),
            ...
            entry: SurfaceComponentEntry::default(),
...
pub struct SurfaceComponentPermissions {
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct AiPermissions {
    /// Whether AI access is enabled for this Surface Component.
    #[serde(default)]
    pub enabled: bool,
...
/// Declared backends that a Surface Component can call through `app.backend.call()`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct SurfaceComponentBackendBinding {
    pub id: String,
    pub kind: SurfaceComponentBackendKind,
    ...
    pub role: String,
    #[serde(default)]
    pub session_policy: SurfaceComponentBackendSessionPolicy,
    #[serde(default)]
    pub memory_scope: SurfaceComponentBackendMemoryScope,
    #[serde(default)]
    pub actions: Vec<SurfaceComponentBackendActionBinding>,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub enum SurfaceComponentBackendKind {
    AgentComponent,
    BridgeComponent,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub enum SurfaceComponentBackendSessionPolicy {
    Ephemeral,
    Persistent,
    PerEntity,
    Shared,
...
impl Default for SurfaceComponentBackendSessionPolicy {
    fn default() -> Self {
        Self::Persistent
    }
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub enum SurfaceComponentBackendMemoryScope {
    None,
    AppInstance,
    Entity,
    AgentComponent,
...
impl Default for SurfaceComponentBackendMemoryScope {
    fn default() -> Self {
        Self::AppInstance
    }
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct SurfaceComponentBackendActionBinding {
    pub name: String,
    #[serde(default)]
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub enum SurfaceComponentInteractionMode {
    Standalone,
    Composite,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SurfaceComponentInteractionText {
    Plain(String),
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct SurfaceComponentInteractionChat {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub backend_id: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub agent_component_id: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub session_policy: Option<SurfaceComponentBackendSessionPolicy>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub memory_scope: Option<SurfaceComponentBackendMemoryScope>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct SurfaceComponentInteractionTab {
    pub id: String,
    #[serde(rename = "type")]
    pub tab_type: String,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub title: Option<SurfaceComponentInteractionText>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct SurfaceComponentInteraction {
    pub mode: SurfaceComponentInteractionMode,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub profile: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub title: Option<SurfaceComponentInteractionText>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub chat: Option<SurfaceComponentInteractionChat>,
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub tabs: Vec<SurfaceComponentInteractionTab>,
}

/// AI context for iteration (stored in meta, not in compiled HTML).
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct SurfaceComponentAiContext {
...
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
#[serde(default)]
pub struct SurfaceComponentRuntimeState {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct SurfaceComponentRuntimeIssue {
    pub app_id: String,
    pub severity: SurfaceComponentRuntimeIssueSeverity,
    pub message: String,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub enum SurfaceComponentRuntimeIssueSeverity {
    Fatal,
    Warning,
    Noise,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct SurfaceComponentRuntimeLog {
    pub app_id: String,
    pub level: SurfaceComponentRuntimeLogLevel,
    pub category: String,
    pub message: String,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub source: Option<String>,
...
#[serde(rename_all = "lowercase")]
pub enum SurfaceComponentRuntimeLogLevel {
    Debug,
    Info,
    Warn,
    Error,
...
/// Full Surface Component entity (in-memory / API).
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SurfaceComponent {
    ...
    #[serde(default)]
    pub tags: Vec<String>,
    #[serde(default, skip_serializing_if = "SurfaceComponentI18n::is_empty")]
    pub i18n: SurfaceComponentI18n,
    pub version: u32,
    pub created_at: i64,
    pub updated_at: i64,

    pub source: SurfaceComponentSource,
    ...
    #[serde(default)]
    pub runtime: SurfaceComponentRuntimeState,
}

#[derive(Debug, Clone, Default, PartialEq, Eq, Serialize, Deserialize)]
pub struct SurfaceComponentLocalizedMeta {
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Debug, Clone, Default, PartialEq, Eq, Serialize, Deserialize)]
pub struct SurfaceComponentI18n {
    #[serde(default, skip_serializing_if = "HashMap::is_empty")]
    pub locales: HashMap<String, SurfaceComponentLocalizedMeta>,
}

impl SurfaceComponentI18n {
    pub fn is_empty(&self) -> bool {
        self.locales.is_empty()
    }
}

/// Surface Component metadata only (for list views; no source/compiled_html).
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SurfaceComponentMeta {
    pub id: String,
    pub name: String,
    pub description: String,
    pub icon: String,
...
impl From<&SurfaceComponent> for SurfaceComponentMeta {
    fn from(app: &SurfaceComponent) -> Self {
        Self {
            id: app.id.clone(),
            name: app.name.clone(),
