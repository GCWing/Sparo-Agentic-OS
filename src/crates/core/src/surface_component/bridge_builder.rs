...
use crate::surface_component::types::{EsmDep, SurfaceComponentPermissions};
use serde_json;
...
pub fn build_csp_content(permissions: &SurfaceComponentPermissions) -> String {
...
/// Default theme CSS variables for Surface Component iframe.
///
...
/// `--sparo-*` namespace.
pub fn build_surface_component_default_theme_css() -> &'static str {
